...
$lang_global = [
  ...
  'err_invalid_input' => 'Entrada no v�lida',
  ...
  'will_be_erased' => 'Ser� irrecuperable borrado de DB!',
  'unlinked' => 'Unlinked',
  'country' => 'Pais',
...
$lang_register = [
  ...
  'banned_ip' => 'Direcci�n IP que usa esta baneado',
  ...
  'email_address_used' => 'Este correo electronico ya tiene una cuenta. <br/>Mas cuentas no pueden ser creadas con esta direcci�n de correo electronico.',
  'referrer_not_found' => 'Lamentablemente, la cuenta indicada no se encuentra en nuestra base de datos.<br/>Aseg�rate de haber introducido un nombre de cuenta v�lido o dejaste  &quot;Invitado por&quot;-en blanco.',
];
...
function lang_index()
{
  $lang_index =
    ...
    'add_motd' => 'Agregar Mensaje del D�a',
    'delete' => 'Eliminar',
...
function lang_char()
{
  $lang_char =
    ...
    'use_numeric' => 'No puede utilizar valores no num�ricos',
    ...
    'max_acc' => 'La cuenta que est� intentando mover el personaje tiene la cantidad maxima de jugadores en el mismo.',
...
function lang_edit()
{
  $lang_edit =
    ...
    'error_updating' => '�Accion de actualizaci�n Error! - No se cambio los campos?',
...
function lang_motd()
{
  $lang_motd =
    ...
    'post_rules' => 'Aviso: la duracion est� limitada a 255 caracteres. <br /> Etiquetas HTML se pueden utilizar.',
...
function lang_user()
{
  $lang_user =
    ...
    'username_pass_too_long' => 'Nombre de usuario / contrasena debe ser de tama�o 4-a-15 caracteres!',
